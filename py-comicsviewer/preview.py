    ...
    def createContentHtml(self):
        try:
            ...
            for i in range(len(self.img)):
                imgList+='<div data-hash="slide'+str(i)+'" class="swiper-slide"><div class="swiper-zoom-container"><img loading="lazy" data-src="'+self.img[i]+'" class="swiper-lazy" /></div><div class="swiper-lazy-preloader swiper-lazy-preloader-white"></div></div>'
